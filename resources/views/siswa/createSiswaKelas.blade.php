            ...
            <div class="modal-body">
                <form id="formCreate" name="formCreate" class="form-horizontal">
                    ...
                    <input type="hidden" name="kelas_id" id="kelas_id" value="{{$kelas->id}}">
                        <div class="position-relative row form-group"><label class="col-sm-4 col-form-label" for="nis">Kelas</label>
                            <div class="col-sm-8"><input type="text" class="form-control" id="kelas" name="kelas" placeholder="Masukan Kode Jurusan" value="{{$kelas->nama}}" readonly maxlength="50" required="">
                                </div>
                        </div>
